...
$sql = mysql_query("UPDATE users SET emailactivated='1' WHERE id='$id'"); 
// Check the database to see if all is right now 
$sql_doublecheck = mysql_query("SELECT * FROM users WHERE id='$id' AND emailactivated='1'"); 
...
// Print message to the browser saying we could not activate them
	...
	<b><br />Your account could not be activated! <br/>
	...
	<br /><b>Congratulations, your account has been activated!<br /><br />
	You will be redirected momentarily....</b>";
...
<!-- Google -->
<meta name="title" content="Yoombler | Account Activation"> 
...
<meta property="og:title" content="Yoombler | Account Activation"> 
